  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "laravel-gradient":
          "linear-gradient(to top right, #FF2D20 5%, #FF6A57, #FFAB7D)", //Laravel gradient
        "vue-gradient": "linear-gradient(to top, #42B883, #35495E)", // Vue gradient
        "python-gradient":
          "linear-gradient(to bottom right, #306998, #FFD43B )", // Python gradient
        "mysql-gradient":
          "linear-gradient(to bottom right, #4479A1 40%, #F29111)", //Myql gradient
        "react-gradient":
          "linear-gradient(to bottom right, #00D8FF 40%, #007ACC)",
      },
      animation: {
