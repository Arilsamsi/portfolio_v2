...
<template>
    <div>
      ...
      >
        <h2 class="text-xl text-black font-bold mb-4 dark:text-white">My Skills</h2>
        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 mt-8">
            <div v-for="skill in skills" :key="skill.name" class="card p-4 bg-gray-100  text-center rounded-lg shadow-lg flex flex-col items-center hover:scale-105">
        ...
        <button
          @click="closePopup"
          class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-800 mt-2"
        >
          Close
        </button>
      </div>
