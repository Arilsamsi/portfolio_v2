...
<template>
    <!-- <Header /> -->
    <!-- Hero Section -->
    <section class="h-[100vh] min-h-screen flex items-center justify-center bg-gradient-to-br from-primary/10 to-secondary/10">
      <div class="text-center animate-fade-in">
        ...
        <a href="https://wa.me/6282393426013" class="bg-[#128c7e] text-white px-8 py-3 rounded-full hover:bg-[#129e7a] transition-colors duration-300">
